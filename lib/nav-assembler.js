...
function renderItem (node, counter) {
  ...
  if (node.url) {
    var extAttrs2 = node.external ? ' target="_blank" rel="noopener noreferrer"' : ''
    return '<li><a class="nav-link" data-href="' + attr(node.url) + '" href="' + attr(node.url) + '"' + extAttrs2 + '>' + label + '</a></li>'
  }
