...
All messages are immutable. Updating a message mandates creating a new message based on the previous one, with extra information added. Imutability guarantees that messages are safe to use in a multithreaded and distributed environment.
