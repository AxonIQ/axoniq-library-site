...
You can unlock additional functionality for your Axon Server by connecting it to xref:axoniq-platform-reference::index.adoc[Axoniq Platform].
...
* xref:developer/linux.adoc[Install on Linux via APT/DNF/YUM package manager]
