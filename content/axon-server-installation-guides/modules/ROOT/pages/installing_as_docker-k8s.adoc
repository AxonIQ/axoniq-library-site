...
We will use "secrets" to inject the license file, tokens as well as the cluster/context definitions using the xref:axon-server/installation/local-installation/README.adoc#auto-clustering[autocluster] mechanism.
