...
In order to run a cluster of Professional nodes, you need to connect it to AxonIQ Console, after enabling your subscription.
...
When connecting to AxonIQ Console, your server will receive all information automatically.

Here below some example of `axonserver-1.properties` `axonserver-2.properties` and `axonserver-3.properties` have to be put into the properties file:
