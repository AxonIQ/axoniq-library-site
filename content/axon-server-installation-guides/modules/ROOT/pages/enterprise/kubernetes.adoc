...
. *Secrets*: A kubernetes secret that safely store your license file (otpional).
...
In order to run a cluster of nodes, you need to provide your configration with an axoniq.license Axon Server license file.
You can obtain it contacting our sales department or through AxonIQ Console.
...
If you decided to handle your license manually and you have a license file, we suggest to save this in a secure place, such as kubernetes secrets or the vault of your choice. 
...
. *Initializing in the Axon Server dashboard*: By going into the Axon Server dashboard after Step 6, you can initialize the cluster manually and upload your file license here.
...
--
====
Auto-clustering/Manual::
+
If you select Auto-clustering or manual, you can provide license as a secret, or optionally upload to the node with the UI.
+
[tabs]
====
axonserver-sts-1.yaml:: 
