...
If you decided to handle your license manually, you should also save this in a secure place, such as kubernetes secrets or the vault of your choice.
In this guide we will store as kubernetes secret.
