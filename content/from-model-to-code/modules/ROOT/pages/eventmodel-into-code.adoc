...
Copy
The _command_ package represents the "command" side/model of the *link:https://www.axoniq.io/concepts[CQRS] pattern*, which is the dominant architectural pattern in our design.
