...
**1. Collect anonymous data** The update checker automatically and anonymously sends technical information about your Axon Framework installation to AxonIQ.
This includes:
...
**2. Identity updates and vulnerabilities:** The AxonIQ server will respond with information about available updates and known vulnerabilities for the Axon modules in use.
