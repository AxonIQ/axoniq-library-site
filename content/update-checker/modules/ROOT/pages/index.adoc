...
**2. Collect data:**
To detect updates and vulnerabilities, the update checker collects anonymous data about your Axon Framework installation. This data is sent to AxonIQ and includes technical information about your environment, such as:
