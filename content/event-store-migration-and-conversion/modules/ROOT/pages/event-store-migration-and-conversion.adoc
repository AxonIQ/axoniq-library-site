...
If you intend to move only a portion of the event store to another location, for example because you want to update the acceptance environment at the end of each day with exactly the events published in one day, you can do that as described below.
